...
<div class="main-header">
    ...
    <p>Tác giả:Bui Thị Lý - Trường Tiểu Học Ngọc Đường -Xã Ngọc Đường- Tuyên Quang - ĐT: 0838561979 343</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Bui Thị Lý - Trường Tiểu Học Ngọc Đường -Xã Ngọc Đường- Tuyên Quang 343</div>", unsafe_allow_html=True)
