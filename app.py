...
<div class="main-header">
    ...
    <p>Tác giả: Bùi Thị Lý - Trường Tiểu Học Ngọc Đường - ĐT: 0838561979</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Bùi Thị Lý - Trường Tiểu Học Ngọc Đường - ĐT: 0838561979</div>", unsafe_allow_html=True)
